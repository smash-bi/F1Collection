...
public final class TestDataMapForHashMap implements TestDataMap
{
	private int size;
	private HashMap<TestDataUUID,TestDataForJavaMap> map;
	
	public TestDataMapForHashMap( final int aSize )
	{
		size = aSize;
		map = new HashMap<TestDataUUID,TestDataForJavaMap>( aSize, 0.75f );
	}
